...
def main_login():
    ...
    def app():
        ...
        def view_violations():
            ...
            violation_root.title("View Violations")
            ...
            def viewclass():
                ...
                if violations != []:
                    ...
                    button_quit = Button(viewing, text='Exit Program', command=viewing.quit)
            ...
            viewv = Button(violation_root, text='View Violations', width=15, command=viewclass)
            select = Label(violation_root, text='Select a class')
